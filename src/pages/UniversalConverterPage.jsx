          ...
          >
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-col gap-2">
                ...
                <UnitSelect value={fromUnit} onChange={setFromUnit} units={category.units} className="w-full" />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-2">
                  <div className={`flex-1 min-w-0 px-4 py-3 rounded-xl border text-xl font-bold
                                   transition-colors duration-200 select-all cursor-text truncate
                                   ${primaryResult !== null
                ...
                <UnitSelect value={toUnit} onChange={setToUnit} units={category.units} className="w-full" />
              </div>
            </div>
